AOS.init({ duration: 800, easing: "slide" }),
  (function (t) {
    ...
    t(window).stellar({
      ...
      t(document).on("click", '#custom-scroll a[href^="#"]', function (e) {
        e.preventDefault(),
          t.attr(this, "href"),
          t("html, body").animate(
            { scrollTop: t(t.attr(this, "href")).offset().top - 70 },
      ...
      t(window).scroll(function () {
        var e = t(this).scrollTop(),
          a = t(".ftco_navbar"),
          s = t(".js-scroll-wrap");
        e > 150 && (a.hasClass("scrolled") || a.addClass("scrolled")),
          e < 150 && a.hasClass("scrolled") && a.removeClass("scrolled sleep"),
          e > 350 &&
            (a.hasClass("awake") || a.addClass("awake"),
            s.length > 0 && s.addClass("sleep")),
          e < 350 &&
            (a.hasClass("awake") &&
              (a.removeClass("awake"), a.addClass("sleep")),
            s.length > 0 && s.removeClass("sleep"));
      }),
      t("#section-counter, .hero-wrap, .ftco-counter, .ftco-about").waypoint(
        function (e) {
          if ("down" === e && !t(this.element).hasClass("ftco-animated")) {
            ...
            t(".number").each(function () {
              var e = t(this),
                s = e.data("number");
              console.log(s),
                e.animateNumber({ number: s, numberStep: a }, 7e3);
            });
          }
        },
        { offset: "95%" }
      ),
      t(".ftco-animate").waypoint(
        function (e) {
          "down" !== e ||
            t(this.element).hasClass("ftco-animated") ||
            (t(this.element).addClass("item-animate"),
            setTimeout(function () {
              t("body .ftco-animate.item-animate").each(function (e) {
                ...
                setTimeout(
                  function () {
                    ...
                    "fadeIn" === t
                      ? a.addClass("fadeIn ftco-animated")
                      : "fadeInLeft" === t
                      ? a.addClass("fadeInLeft ftco-animated")
                      : "fadeInRight" === t
                      ? a.addClass("fadeInRight ftco-animated")
                      : a.addClass("fadeInUp ftco-animated"),
    ...
    (e.prototype.tick = function () {
      ...
      (window.onload = function () {
        for (
          var t = document.getElementsByClassName("txt-rotate"), a = 0;
          a < t.length;
          a++
        ) {
        ...
        (n.type = "text/css"),
          (n.innerHTML =
            ".txt-rotate > .wrap { border-right: 0.09em solid #999 }"),
  ...
  (function (t) {
    ...
    s.click(function (e) {
      ...
      t(window).scroll(function (o) {
        ...
        l !== a &&
          ((a = l),
          t(s).removeClass("current"),
          t('#navi a[href="#' + a + '"]').addClass("current"));
      });
  })(jQuery),
  (hash = function (t) {
  ...
  $(function () {
    ...
    $(".progress").each(function () {
      ...
      e > 0 &&
        (e <= 50
          ? s.css("transform", "rotate(" + t(e) + "deg)")
          : (s.css("transform", "rotate(180deg)"),
            a.css("transform", "rotate(" + t(e - 50) + "deg)")));
    });
  });
